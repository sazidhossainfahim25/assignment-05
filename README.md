1 : var ,let const is a javascript variable. var is type of function-scoped,let is type block-scoped and re-assignable , const is type block-scoped immutable or block-scoped and not re-assignable

2 : ... spread this operator copies the main array and expands the object correctly.
3 : forEach is loops through an array for side effects  does not return a new array.
